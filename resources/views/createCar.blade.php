        ...
        <div class="card-body LRBody">
            <form method="POST" action="{{ route('post.car') }}" enctype="multipart/form-data">
                ...
                <div class="form-group LRInput">
                    ...
                    <input name="CarName" type="text" class="form-control" id="CarName" value="{{ old('CarName') }}"
                        placeholder="e.g. GTR">
                </div>
                ...
                <div class="form-group LRInput">
                    ...
                    <input name="Velocity" type="number" class="form-control" id="Velocity" placeholder="e.g. 200" min="1"
                        max="800" step="1" value="{{ old('Velocity') }}">
                </div>
                <div class="form-group LRInput">
                    <label for="Acceleration">Acceleration (0-100 Km/h)</label>
                    <input name="Acceleration" type="number" class="form-control" id="Acceleration" placeholder="e.g. 2.8"
                        min="1" max="15" step="0.1" value="{{ old('Acceleration') }}">
                </div>
                <div class="form-group LRInput">
                    <label for="Acceleration">PS</label>
                    <input name="PS" type="number" class="form-control" id="PS" placeholder="e.g. 600" min="1" max="3000"
                        step="1" value="{{ old('PS') }}">
                </div>
                <div class="form-group LRInput">
                ...
                <div class="form-group LRInput">
                    ...
                    <input name="Weight" type="number" class="form-control" id="Weight" placeholder="e.g. 1200" min="1"
                        max="30000" step="1" value="{{ old('Weight') }}">
                </div>
                <div class="form-group LRInput">
                    <label for="Weight">Seats</label>
                    <input name="Seats" type="number" class="form-control" id="Seats" placeholder="e.g. 2" min="1" max="20"
                ...
                <div class="form-group LRInput">
                    ...
                    <input name="Doors" type="number" class="form-control" id="Doors" placeholder="e.g. 4" min="1" max="8"
                        step="1" value="{{ old('Doors') }}">
                </div>
                <div class="form-group LRInput">
                    <label for="Torque">Torque</label>
                    <input name="Torque" type="number" class="form-control" id="Torque" placeholder="e.g. 1300" min="1"
                        max="9000" step="1" value="{{ old('Torque') }}">
                </div>
                <div class="form-group LRInput">
